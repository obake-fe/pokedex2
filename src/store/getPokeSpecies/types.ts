...
export const SEARCH_NAME_RESET = "SEARCH_NAME/POKE_SPECIES/RESET_DATA";
...
export const SEARCH_TYPE_RESET = "SEARCH_TYPE/POKE_SPECIES/RESET_DATA";
...
export const SEARCH_PARTNER_RESET = "SEARCH_PARTNER/POKE_SPECIES/RESET_DATA";
